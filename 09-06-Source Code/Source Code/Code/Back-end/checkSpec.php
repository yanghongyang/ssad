...
$sql=("select count(*) as journalNum from specialist, specialist_achievement, achievement, paper ".
    "where  specialist.id=specialist_achievement.sid and specialist_achievement.aid=achievement.id and achievement.id=paper.id and specialist.id='$SID' and paper.database='Journal' ".
    "group by specialist.id ");
$runSQL=mysqli_query($con, $sql);
if($runSQL){
    $ok=0;
...
$sql=("select count(*) as sessionNum from specialist, specialist_achievement, achievement, paper ".
    "where specialist.id=specialist_achievement.sid and specialist_achievement.aid=achievement.id and achievement.id=paper.id and specialist.id='$SID' and paper.database='Conference' ".
    "group by specialist.id ");
$runSQL=mysqli_query($con, $sql);
if($runSQL){
    $ok=0;
...
$sql=("select count(*) as zhuanzhuNum from specialist, specialist_achievement, achievement, paper ".
    "where specialist.id=specialist_achievement.sid and specialist_achievement.aid=achievement.id and achievement.id=paper.id and specialist.id='$SID' and paper.database='Monograph' ".
    "group by specialist.id ");
$runSQL=mysqli_query($con, $sql);
if($runSQL){
    $ok=0;
...
$sql=("select count(*) as elseNum from specialist, specialist_achievement, achievement, paper ".
    "where specialist.id=specialist_achievement.sid and specialist_achievement.aid=achievement.id and achievement.id=paper.id andspecialist.id='$SID' and paper.database='Other' ".
    "group by specialist.id ");
$runSQL=mysqli_query($con, $sql);
if($runSQL){
    $ok=0;
